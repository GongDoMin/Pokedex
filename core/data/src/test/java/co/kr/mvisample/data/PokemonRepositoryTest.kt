...
class PokemonRepositoryTest : StringSpec() {
    ...
    init {
        ...
        "포켓몬을 발견한다." {
            pokemonRepository.markAsDiscovered(6).testTurbine {
                awaitItem()
                awaitItem()
        ...
        "포켓몬을 포획한다." {
            pokemonRepository.markAsCaught(6).testTurbine {
                awaitItem()
                awaitItem()
        ...
        "포켓몬을 놓아준다." {
            pokemonRepository.markAsRelease(6).testTurbine {
                awaitItem()
                awaitItem()
        ...
        "포켓몬 상세 정보를 불러온다." {
            pokemonRepository.fetchPokemonDetail(id = 6, name = "charizard").testTurbine {
        ...
        "포켓몬 순서를 변경한다." {
            ...
            pokemonRepository.swapPokemonOrder(6, 9).testTurbine {
                awaitItem()
                awaitItem()
